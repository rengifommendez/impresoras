...
import { getDashboardStats, getTotalByUser } from '../lib/supabase';
import { StatsCard } from './StatsCard';
import { UsersTable } from './UsersTable';

export function Dashboard() {
  // Consultar estadísticas generales usando función helper
  ...
  // Consultar totales por usuario usando función helper
