...
import { LogOut, Printer, BarChart3, Upload, Users, FileText, Settings, Monitor } from 'lucide-react';
import { useAuth } from '../hooks/useAuth';

interface LayoutProps {
  children: React.ReactNode;
  currentPage?: 'dashboard' | 'upload' | 'users' | 'reports' | 'management' | 'printers';
